    ...
    <div id="content_menu">
      <ul class="menu">
        <li><?php echo anchor('administrador/perfil', 'Información de mi perfil')?></li>
				 <li class="active"><?php echo anchor('administrador/perfil/update_password', 'Change Password')?></li>
      </ul>
      <p class="information">La pestaña de "Opciones de mi perfil" te permite editar tu perfil</p>
    </div>
    <div class="content">
