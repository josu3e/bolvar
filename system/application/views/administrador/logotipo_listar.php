        ...
        <table class="tbl_lista" cellspacing="0" summary="Lista de archivos" width="98%">
          <thead>
            <tr><?php $order = ($this->uri->segment(5) == 'desc')?'asc':'desc';?>
              <th scope="col"><?php echo anchor('administrador/archivos/listar/id/'.$order, 'Logo1', 'class="'.$order.'" title="Ordenar de forma '.$order.'endente"')?></th>              
							<th scope="col"><?php echo anchor('administrador/archivos/listar/id/'.$order, 'Logo2', 'class="'.$order.'" title="Ordenar de forma '.$order.'endente"')?></th>
          ...
          <tbody>
            <?php echo (isset($logotipos))?$logotipos:'';?>
          </tbody>
        </table>
