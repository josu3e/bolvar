    ...
    <div id="content_menu">
      <ul class="menu">
        <li class="active"><?php echo anchor('administrador/perfil', 'Información de mi perfil')?></li>
				 <li><?php echo anchor('administrador/perfil/load_change_pass', 'Cambiar Password')?></li>
      </ul>
      <p class="information">La pestaña de "Opciones de mi perfil" te permite editar tu perfil y cambiar tu password</p>
    </div>
    <div class="content">
      <h1>Mi perfil</h1>
      <div class="listing">
