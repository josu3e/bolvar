...
class Permissions Extends Model
{
	...
	{
		$this->db->where_in('per_rol_id', $roles_id);
	...
	function get_permissions_data($roles_id, $array_key = 'per_rol_id', $unserialize = TRUE)
	{
		$result = array();
	...
	{
		$this->db->where('per_rol_id', $role_id);
		return $this->db->get($this->_table);
	}
