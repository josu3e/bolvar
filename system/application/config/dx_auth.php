...
$config['DX_deny_uri'] = '/autenticacion/deny/';
$config['DX_login_uri'] = '/autenticacion/login/';
$config['DX_banned_uri'] = '/autenticacion/banned/';
$config['DX_activate_uri'] = '/autenticacion/activate/';
$config['DX_reset_password_uri'] = '/autenticacion/reset_password/';
...
// URI Locations
$config['DX_logout_uri'] = '/autenticacion/logout/';
$config['DX_register_uri'] = '/autenticacion/register/';
$config['DX_forgot_password_uri'] = '/autenticacion/forgot_password/';
$config['DX_change_password_uri'] = '/autenticacion/change_password/';
$config['DX_cancel_account_uri'] = '/autenticacion/cancel_account/';

// Forms view
$config['DX_login_view'] = 'autenticacion/login_form';
$config['DX_register_view'] = 'autenticacion/register_form';
$config['DX_forgot_password_view'] = 'autenticacion/forgot_password_form';
$config['DX_change_password_view'] = 'autenticacion/change_password_form';
$config['DX_cancel_account_view'] = 'autenticacion/cancel_account_form';

// Pages view
$config['DX_template_view'] = 'autenticacion/template';
$config['DX_deny_view'] = 'autenticacion/general_message';
$config['DX_banned_view'] = 'autenticacion/general_message';
$config['DX_logged_in_view'] = 'autenticacion/general_message';
$config['DX_logout_view'] = 'autenticacion/general_message';

$config['DX_register_success_view'] = 'autenticacion/general_message';
$config['DX_activate_success_view'] = 'autenticacion/general_message';
$config['DX_forgot_password_success_view'] = 'autenticacion/general_message';
$config['DX_reset_password_success_view'] = 'autenticacion/general_message';
$config['DX_change_password_success_view'] = 'autenticacion/general_message';

$config['DX_register_disabled_view'] = 'autenticacion/general_message';
$config['DX_activate_failed_view'] = 'autenticacion/general_message';
$config['DX_reset_password_failed_view'] = 'autenticacion/general_message';
