...
class CI_Email {
	...
	var	$smtp_host		= "mail.gsp-peru.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "webmaster@gsp-peru.com";		// SMTP Username
	var	$smtp_pass		= "gsp8115";		// SMTP Password
